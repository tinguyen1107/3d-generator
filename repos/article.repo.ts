import { ArticleApi, CreateArticleInput, CreatePostInput, PostApi } from '../apis';
import { FETCH_POSTS_LIMIT } from '../constants';
import { GetListInput } from '../core/types';
import { DB } from '../db';
import { CommentCreateInput, CommentDto, CommentEditInput, PostDto } from '../dtos';
...
export class ArticleRepo {
  ...
  // }
  static async createArticle(input: CreateArticleInput): Promise<void> {
    return ArticleApi.createArticle(input);
  }
  //
